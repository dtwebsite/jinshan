$(document).ready(function() {
    ...
    var cursor = $("#js-follower");
    var cursorSpan = $("#js-follower span");
    // cursor.createElement("span");

    $(window).mousemove(function(e) {
        // var posX =  e.clientX - cursor.width() / 2;      
        // var posY =  e.clientY - cursor.height() / 2;
        var posX =  e.clientX - cursor.width() / 2;      
        var posY =  e.clientY - cursor.height() / 2;
        cursor.css({
    ...
    $(".link")
        ...
        .mouseleave(function() {                       
            ...
            this.timer = setTimeout(function(){
                cursor.removeClass("is-bounce-in");
            },100);
            cursor.addClass("is-bounce-out");
            this.timer = setTimeout(function(){
                cursor.removeClass("is-bounce-out");
            },1200);
            // cursorSpan.css({
            //     transform: "scale(1)"
            // });
