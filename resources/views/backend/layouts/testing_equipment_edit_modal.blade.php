@section('testing_equipment_edit_modal')
{{-- 修改功能Start --}}
<div class="modal fade" id="modal-edit">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">編輯檢測設備圖片</h4>
...
<script type="text/javascript">
	function testing_equipment_edit(){
		$('.edit').click(function(){
			$('#modal-edit').modal('show');
			document.getElementById('edit_form').reset();
			var edit_id = $(this).data('id');
			$.get('{{ asset('admin/testing_equipment') }}/'+edit_id+'/edit',function(res){
				$('[name=id]').val(res.id);
	...
	$('#edit_form').submit(function(){
		...
		$.ajax({
			type:"POST",
			url:'{{ asset("admin/testing_equipment")}}/'+edit_id,
			dataType:'json',
			data:formdata,
			async: false,
			cache: false,
