@section('testing_equipment_detail_edit_modal')
{{-- 修改功能Start --}}
...
<script type="text/javascript">
	function testing_equipment_detail_edit(){
		$('.edit').click(function(){
			...
			$('.img_content').html('');
			$.get('{{ asset('admin/testing_equipment_detail') }}/'+pid+'/edit',function(res){
	...
	$('#edit_form').submit(function(){
		...
		$.ajax({
			type:"POST",
			url:'{{ asset("admin/testing_equipment_detail")}}/'+pid,
			dataType:'json',
			data:formdata,
			async: false,
			cache: false,
